...
def generate_songs_json(folder_path):
    ...
    # Base URL for accessing raw files on GitHub
    base_url = "https://media.githubusercontent.com/media/bencarpe420/bencarpe420.github.io/refs/heads/main/Songs/"
    ...
    with open('SongNames.json', 'w') as json_file:
